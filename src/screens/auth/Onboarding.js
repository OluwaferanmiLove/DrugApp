  ...
  return (
    ...
    <ImageBackground style={styles.main} source={require('../../assets/bg.png')}>
        ...
        <View style={{ marginTop: hp(80), alignItems: 'center', justifyContent: 'center', marginHorizontal: wp(25)}}>
          <Text style={styles.title}>Drug Reminder System</Text>
          <Text style={{color: colors.primary, fontSize: wp(16), marginTop: hp(12)}}>Get notification remiders for your drugs</Text>
        </View>
